...
class LiDARInstance3DBoxes(BaseInstance3DBoxes):
    ...
    and the yaw is around the z axis, thus the rotation axis=2. z轴标号2
    ...
    #? 返回xyxy格式，即左上角和右下角
    @property
    def nearest_bev(self): # 获取最近的BEV框
    ...
    def rotate(self, angle, points=None):
        ...
        Returns:
            tuple or None: When ``points`` is None, the function returns \
                ...
                rotation matrix ``rot_mat_T``. #? 注意返回
        """
    ...
    def points_in_boxes(self, points):
        ...
        Returns:
            torch.Tensor: The index of box where each point are in. #? 每个点在哪个框里
        """
