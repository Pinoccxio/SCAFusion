...
# :~/miniconda3/envs/bev/lib/python3.8/site-packages/mmdet/models/backbones
import warnings
...
class SwinBlock(BaseModule):
    ...
    def forward(self, x, hw_shape):
        ...
        def _inner_forward(x):
            ...
            # Add first Mona module after attention
            ...
            # Add second Mona module after FFN
...
class SwinTransformer_mona(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(SwinTransformer_mona, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        ...
        for name, param in self.named_parameters():
            if 'mona' not in name:  # 如果参数名中不包含'mona'，则冻结该参数
                param.requires_grad = False
            else:  # Mona模块的参数保持可训练状态
                param.requires_grad = True
                logger.info(f'Keep parameter {name} trainable')
